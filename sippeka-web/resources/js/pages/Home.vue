<template>
    <main class="main">
        ...
        <section id="hero" class="hero section">
            <div class="hero-bg">
                <img src="/assets/user/img/hero-bg-light.webp" alt="">
            </div>
            <div class="container text-center">
                <div class="d-flex flex-column justify-content-center align-items-center">
                    ...
                    <img src="/assets/user/img/hero-services-img.webp" class="img-fluid hero-img" alt=""
                    ...
                    <div class="col-xl-4 col-lg-6" data-aos="fade-up" data-aos-delay="200">
                        <div class="service-item d-flex">
                            ...
                            <div>
                                ...
                                <p class="description">Menjadi pusat unggulan pengembangan keterampilan tenaga kerja
                                    yang
            ...
            <div class="container">
                <div class="row gy-4">
                    <div class="col-lg-6 content" data-aos="fade-up" data-aos-delay="100">
                        ...
                        <p class="fst-italic">
                            Balai Latihan Kerja milik pemerintah di bawah naungan Direktorat Jenderal Pembinaan
                            Pelatihan
                        ...
                        <ul>
                            ...
                            <li><i class="bi bi-check-circle"></i> <span>Kolaborasi dengan Industri dan
                                    Pemerintah.</span>
                            </li>
                        </ul>
                    </div>
                    ...
                    <div class="col-lg-6 about-images" data-aos="fade-up" data-aos-delay="200">
                        <div class="row gy-4">
                            <div class="col-lg-6">
                                <img src="/assets/user/img/about-company-1.jpg" class="img-fluid" alt="">
                            </div>
                            <div class="col-lg-6">
                                <div class="row gy-4">
                                    <div class="col-lg-12">
                                        <img src="/assets/user/img/about-company-2.jpg" class="img-fluid"
                                            alt="">
                                    </div>
                                    <div class="col-lg-12">
                                        <img src="/assets/user/img/about-company-3.jpg" class="img-fluid"
                                            alt="">
                                    </div>
                                </div>
                            </div>
        ...
        <section id="clients" class="clients section">
            <div class="container" data-aos="fade-up">
                <div class="row gy-4">
                    ...
                    <div class="col-xl-2 col-md-3 col-6 client-logo">
                        <img src="/assets/user/img/silastri/logo_disnakertrans.png" class="img-fluid"
                            alt="">
                    </div>
                    <!-- End Client Item -->
                    ...
                    <div class="col-xl-2 col-md-3 col-6 client-logo">
                        <img src="/assets/user/img/silastri/logo_zona_integritas.png" class="img-fluid"
                            alt="">
                    </div>
                    <!-- End Client Item -->
                            ...
                            <li class="nav-item">
                                <a class="nav-link" data-bs-toggle="tab" data-bs-target="#features-tab-3">
                                    ...
                                    <div>
                                        ...
                                        <p>
                                            Peserta dapat membangun jaringan profesional yang dapat mendukung
                                            perkembangan
                ...
                <div class="row gy-4 justify-content-between features-item">
                    <div class="col-lg-5 d-flex align-items-center order-2 order-lg-1" data-aos="fade-up"
                        ...
                        <div class="content">
                            ...
                            <p>
                                Informasi seputar jurusan yang tersedia, tata cara pendaftaran dan jadwal tes di UPT BLK
                                Singosari Malang.
                            </p>
                            <p></p>
                            <a href="/info-pelatihan" class="btn more-btn">Cek Disini!</a>
                        </div>
                    </div>
                ...
                <div class="row gy-4 justify-content-between features-item">
                    ...
                    <div class="col-lg-5 d-flex align-items-center" data-aos="fade-up" data-aos-delay="200">
                        <div class="content">
                            ...
                            <p>
                                Hasil seleksi peserta adalah informasi yang akurat! Informasi ini memuat data dari hasil
                                tes
                                ujian dan tes wawancara dengan menampilkan nilai yang diperoleh selama mengikuti seleksi
                                pendaftaran.
                            </p>
                            <a href="/hasil-pengumuman" class="btn more-btn">Lihat</a>
                        </div>
                    </div>
                </div>
            </div>
