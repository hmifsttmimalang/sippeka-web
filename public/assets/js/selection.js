$(window).on('load', function () {
    ...
    function updateBadgeCount() {
        ...
        $('#completed-badge').text(`${completedCount} Answered`);
    }
    ...
    document.querySelectorAll(".finish-test").forEach((button) => {
        button.addEventListener("click", function (event) {
            ...
            swalWithBootstrapButtons
                .fire({
                    title: "Do you want to end the examination?",
                    icon: "warning",
                ...
                .then((result) => {
                    if (result.isConfirmed) {
                        ...
                        if (!skillTestSessionId || !csrfToken || !username) {
                            alert('Data error occurred. Please refresh the page.');
                            return;
                        }

                        $.ajax({
                            url: `/${username}/selection`,
                            method: 'POST',
                            data: {
                            ...
                            success: function (response) {
                                ...
                                window.location.href = `/${username}/selection/result`;
                            },
    ...
    function formatTime(totalSeconds) {
        ...
        return `${hours} hr, ${minutes} min, ${padZero(seconds)} sec`;
    }
    ...
    $(document).ready(function () {
        ...
        timerInterval = setInterval(function () {
            ...
            if (remainingTime <= 0) {
                ...
                window.location.href = `/${username}/selection/timeout`;
            }
        }, 1000);
    });
});