            ...
            <li class="nav-item ">
              ...
              <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                <div class="bg-white py-2 collapse-inner rounded">
                    <a class="collapse-item active" href="mata_soal_keahlian.php">Mata Soal Keahlian</a>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <a href="tambah_mata_keahlian.php" class="btn btn-primary btn-sm">Tambah</a>
                                ...
                                <table class="table table-bordered table-hover">
                                  ...
                                  <tbody>
                                    <tr>
                                        ...
                                        <td>
                                          <a href="edit_keahlian.php" class="btn btn-primary btn-sm">Edit</a>
