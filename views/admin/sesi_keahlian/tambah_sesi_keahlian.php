        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Button Kembali -->
                    <a href="sesi_tes_keahlian.php" class="btn btn-primary btn-sm mb-6">Kembali</a>
                                    ...
                                    <form class="user">
                                        <div class="form-group row">
                                            <div class="col-md-6">
                                                ...
                                                <input type="text" name="nama_sesi" class="form-control" id="nama_sesi" 
                                                placeholder="Masukkan nama sesi tes keahlian">
                                            </div>
                                            <div class="col-md-6">
