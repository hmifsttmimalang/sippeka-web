    ...
    <div id="wrapper">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <!-- Button Kembali -->
                <a href="tes_keahlian.php" class="btn btn-primary btn-sm">Kembali</a>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="p-5">
                                    ...
                                    <hr class="divider-sidebar">
                                    <a href="tambah_soal_tes_keahlian.php" class="btn btn-primary mb-3">Tambah</a>
                                    <a href="import_soal_tes.php" class="btn btn-primary mb-3">Import</a>
                                <table class="table table-bordered table-hover right-align">
                                    <tr>
                                        <th>No</th>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="edit_detail_tes.php" class="btn btn-primary btn-sm">Edit</a>
