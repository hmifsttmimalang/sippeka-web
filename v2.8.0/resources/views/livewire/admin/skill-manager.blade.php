                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                            ...
                            <input wire:model.live.debounce.300ms="search" type="text"
                                ...
                                placeholder="Cari kelas keahlian...">
                        </div>
                        <div class="card-body">
                                            ...
                                            <tr class="text-center">
                                                ...
                                                <td>
                                                    <button wire:click="openModal({{ $skill->id }})"
                                                        class="btn btn-warning btn-sm btn-circle shadow-sm" title="Edit">
                                                    ...
                                                    <button
                                                        ...
                                                        class="btn btn-danger btn-sm btn-circle shadow-sm" title="Hapus">
            ...
            <div class="card-body">
                <form wire:submit="save">
                    <div class="form-group">
                        ...
                        @enderror
                        <small class="form-text text-muted">Nama ini akan tampil sebagai pilihan program di form pendaftaran peserta.</small>
                    </div>
                    <hr>
