...
<head>
    ...
    <style>
        body { font-family: 'Helvetica', sans-serif; font-size: 11px; margin: 0; padding: 0; }
        ...
        .ph-1 { font-size: 14px; text-transform: uppercase; }
        .ph-2 { font-size: 18px; font-weight: bold; text-transform: uppercase; margin: 2px 0; }
        .ph-3 { font-size: 10px; margin-top: 5px; }
        ...
        .value { width: 65%; }
        .section-title { font-weight: bold; border-bottom: 1px solid #000; padding-bottom: 5px; margin-top: 25px; font-size: 12px; }
...
<body>
    ...
    <table>
        ...
        <tr>
            ...
            <td class="value">: {{ $pendaftar->tempat_lahir }}, {{ \Carbon\Carbon::parse($pendaftar->tanggal_lahir)->translatedFormat('d F Y') }}</td>
        </tr>
        <tr>
    ...
    <table>
        ...
        <tr>
            ...
            <td class="value">: {{ $pendaftar->nilai_wawancara !== null ? number_format($pendaftar->nilai_wawancara, 1) : 'Belum dinilai' }}</td>
        </tr>
        <tr>
            <td class="label">Nilai Rata-rata</td>
            <td class="value">: {{ $pendaftar->average_score !== null ? number_format($pendaftar->average_score, 1) : '-' }}</td>
        </tr>
        <tr>
