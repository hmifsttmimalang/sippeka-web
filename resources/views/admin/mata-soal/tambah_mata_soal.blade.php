...
@section('title', 'Tambah Mata Soal | Admin Sippeka')
            ...
            <li class="nav-item ">
                ...
                <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <a class="collapse-item active" href="{{ route('admin.mata_soal') }}">Mata Soal Keahlian</a>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Button Kembali -->
                    <a href="{{ route('admin.mata_soal') }}" class="btn btn-primary btn-sm mb-6">Kembali</a>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="p-5">
                                        ...
                                        <form class="user" action="{{ route('admin.mata_soal.store') }}"
                                            method="post">
                                            @csrf
                                            @method('POST')
