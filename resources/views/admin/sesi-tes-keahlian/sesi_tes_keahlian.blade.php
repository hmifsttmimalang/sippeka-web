                ...
                <div class="container-fluid">
                        ...
                        <div class="d-flex justify-content-between mb-4">
                            ...
                            <form class="form-inline my-2 my-lg-0">
                                <input class="form-control mr-2" type="search" name="search"
                                    placeholder="Cari Sesi Tes atau Jenis Sesi" value="{{ request('search') }}"
                                    aria-label="Search">
                    ...
                    @else
                        @if ($search)
                            ...
                            <h3 class="text-center mt-2">Tidak ada sesi tes yang sesuai dengan pencarian.</h3>
                        @else
                            <h3 class="text-center mt-2">Tidak ada sesi tes yang tersedia</h3>
                        @endif
                    @endif
                </div>
