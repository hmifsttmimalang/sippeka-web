...
@section('title', 'Tambah Sesi Tes Keahlian | Admin Sippeka')
                                            ...
                                            <div class="form-group row">
                                                <div class="col-md-6">
                                                    ...
                                                    <input type="datetime-local" class="form-control"
                                                        placeholder="Pilih Tanggal dan Waktu" name="waktu_mulai">
                                                </div>
                                                <div class="col-md-6">
                                                    <label for="waktu_selesai">Waktu Selesai</label>
                                                    <input type="datetime-local" class="form-control"
                                                        placeholder="Pilih Tanggal dan Waktu" name="waktu_selesai">
                                                </div>
                                            </div>
                                            <div class="form-group row">
