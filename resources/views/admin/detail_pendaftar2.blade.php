            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                        ...
                        <a href="kelola_data.php" class="btn btn-primary btn-sm mb-6">Kembali</a>
                        ...
                        <div class="row justify-content-center">
                            ...
                            <div class="card shadow mb-4">
                                ...
                                <span class="badge badge-warning mt-2 mb-3" style="height:30px; line-height:25px;">Menunggu</span>

                                <ul class="list-group">
                                    <li class="list-group-item">
                                        <h6 class="mb-1" style="color: black; font-weight: bold; text-align: left;">Nama</h6>
                                        <h6 class="mb-0" style="color: black; text-align: left;">Kacung Suryono S.H</h6>
                                    </li>
                                    <li class="list-group-item">
                                    ...
                                    <li class="list-group-item">
                                        ...
                                        <h6 class="mb-0" style="color: black; text-align: left;">Malang, 27 April 1999</h6>
                                    </li>
                                    <li class="list-group-item">
                                        <h6 class="mb-1" style="color: black; font-weight: bold; text-align: left;">Keahlian</h6>
                                        <h6 class="mb-0" style="color: black; text-align: left;">Mobile Developer</h6>                            
                                    </li>
                                    <li class="list-group-item">
                                        <h6 class="mb-1" style="color: black; font-weight: bold; text-align: left;">Nilai Tes Keahlian</h6>
                                        <h6 class="mb-0" style="color: black; text-align: left;">54</h6>                            
                                    </li>
                                    <li class="list-group-item">
                                        <h6 class="mb-1" style="color: black; font-weight: bold; text-align: left;">Nilai Tes Wawancara</h6>
                                        <h6 class="mb-0" style="color: black; text-align: left;">74</h6>                            
                                    </li>
                                    <li class="list-group-item">
                                        <h6 class="mb-1" style="color: black; font-weight: bold; text-align: left;">Rata - Rata</h6>
                                        <h6 class="mb-0" style="color: black; text-align: left;">64</h6>                            
                                    </li>
                                    <li class="list-group-item">
                                        <h6 class="mb-1" style="color: black; font-weight: bold; text-align: left;">Status</h6>
