...
@section('title', 'Tambah Informasi Jadwal Tes | Admin Sippeka')
                        ...
                        <div class="card-body p-0">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="p-5">
                                        <div class="">
                                            <h1 class="h4 text-gray-900 mb-4">Tambah Informasi Jadwal Tes</h1>
                                        </div>
                                        <hr class="divider-sidebar">
                                        <form action="{{ route('admin.jadwal_tes.store') }}" method="POST">
                                            @csrf
