...
@section('title', 'Tambah Tes Keahlian | Admin Sippeka')
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Button Kembali -->
                    <a href="{{ route('admin.tes_keahlian') }}" class="btn btn-primary btn-sm mb-6">Kembali</a>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="p-5">
                                        ...
                                        <form class="user" method="post" action="{{ route('admin.tes_keahlian.store') }}">
                                            @csrf
                                            @method('POST')
                                            <div class="form-group">
                                                <label for="nama_tes">Nama Tes</label>
                                                <input type="text" name="nama_tes" class="form-control"
                                                    id="nama_tes" placeholder="Masukkan Nama Mata Keahlian">
                                            </div>
