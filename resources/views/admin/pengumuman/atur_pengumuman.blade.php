...
@section('title', 'Atur Pengumuman | Admin Sippeka')
            ...
            <li class="nav-item">
                ...
                <div id="collapseThree" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item loadPage active" href="{{ route('admin.pengumuman') }}">Atur Pengumuman</a>
                    </div>
                </div>
            </li>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="p-5">
                                        ...
                                        <hr class="divider-sidebar">
                                        <form method="POST" action="{{ route('admin.simpan_pengumuman') }}">
                                            @csrf
                                            <div class="col-md-6">
