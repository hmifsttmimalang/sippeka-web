...
@section('title', 'Tambah Informasi Jurusan | Admin Sippeka')
                        ...
                        <div class="card-body p-0">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="p-5">
                                        <div class="">
                                            <h1 class="h4 text-gray-900 mb-4">Tambah Informasi Jurusan</h1>
                                        </div>
                                        ...
                                        <form action="{{ route('admin.info_jurusan.store') }}" method="POST">
                                            ...
                                            <button type="button" class="btn btn-primary btn-tambah">Tambah Jurusan</button>
                                        </form>                                        
                                    </div>
                                </div>
                            </div>
