...
@section('title', 'Ubah Informasi Jurusan | Admin Sippeka')
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Button Kembali -->
                    <a href="{{ route('admin.info_jurusan') }}"
                                ...
                                <div class="col-md-12">
                                    <div class="p-5">
                                        ...
                                        <form action="{{ route('admin.info_jurusan.update', ['id' => $jurusan->id]) }}" method="POST">
                                            ...
                                            <div class="form-group">
                                                <label for="nama_jurusan">Nama Jurusan</label>
                                                <input type="text" class="form-control" name="nama_jurusan" placeholder="Masukkan Nama Jurusan" value="{{ $jurusan->nama_jurusan }}" required>
                                            </div>
                                        
                                            <div class="form-group">
                                                <label for="kuota">Kuota</label>
                                                <input type="number" class="form-control" name="kuota" placeholder="Masukkan Kuota" value="{{ $jurusan->kuota }}" required>
                                            </div>
                                        
                                            <div class="form-group">
                                                <label for="status">Status</label>
                                                <select class="form-control" name="status">
                                                    <option value="dibuka" {{ $jurusan->status == 'dibuka' ? 'selected' : '' }}>Dibuka</option>
                                                    <option value="ditutup" {{ $jurusan->status == 'ditutup' ? 'selected' : '' }}>Ditutup</option>
                                                </select>
                                            </div>
                                        
                                            <button type="button" data-id="{{ $jurusan->id }}" data-nama="{{ $jurusan->nama_jurusan }}" class="btn btn-primary btn-ubah">Ubah Jurusan</button>
                                        </form>
                                    </div>
                                </div>
                            </div>
