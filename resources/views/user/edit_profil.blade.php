...
@section('content')
    ...
    <main id="main" class="main">
        ...
        <div class="row">
            <div class="col-md-8">
                <form class="user" method="post" action="{{ route('user.update_profil', ['username' => auth()->user()->username]) }}" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="form-group mb-3">
                        ...
                        <input type="text" name="nama" class="form-control" id="nama" value="{{ old('nama', $pendaftar->nama) }}">
                    </div>
                    <div class="form-group row mb-3">
                        <div class="col-md-6">
                            <label for="tempat_lahir">Tempat Lahir</label>
                            <input type="text" name="tempat_lahir" class="form-control" id="tempat_lahir" value="{{ old('tempat_lahir', $pendaftar->tempat_lahir) }}">
                        </div>
                        <div class="col-md-6">
                            <label for="tanggal_lahir">Tanggal Lahir</label>
                            <input type="date" name="tanggal_lahir" class="form-control" id="tanggal_lahir" value="{{ old('tanggal_lahir', date('Y-m-d', strtotime($pendaftar->tanggal_lahir))) }}">
                        </div>
                    </div>
                    <div class="form-group row mb-3">
                        <div class="col-md-6">
                            ...
                            <div class="form-check">
                                <input type="radio" name="jenis_kelamin" value="Laki-laki" class="form-check-input" id="laki" {{ old('jenis_kelamin', $pendaftar->jenis_kelamin) == 'Laki-laki' ? 'checked' : '' }}>
                                <label for="laki" class="form-check-label">Laki-Laki</label>
                            </div>
                            <div class="form-check">
                                <input type="radio" name="jenis_kelamin" value="Perempuan" class="form-check-input" id="perempuan" {{ old('jenis_kelamin', $pendaftar->jenis_kelamin) == 'Perempuan' ? 'checked' : '' }}>
                        ...
                        <div class="col-md-6">
                            ...
                            <select name="agama" id="agama" class="form-control">
                                ...
                                @foreach ($agama_options as $option)
                                    <option value="{{ $option }}" {{ old('agama', $pendaftar->agama) == $option ? 'selected' : '' }}>{{ $option }}</option>
                                @endforeach
                            </select>
                        </div>
                    </div>
                    ...
                    <div class="form-group mb-3">
                        ...
                        <input type="text" name="telepon" class="form-control" id="telepon" value="{{ old('telepon', $pendaftar->telepon) }}">
                    </div>
                    <hr>
                    <div class="form-group mb-3">
                        <label for="email">Email</label>
                        <input type="email" name="email" class="form-control" id="email" placeholder="Email Aktif Anda..." value="{{ old('email', $user->email) }}">
                    </div>
                    <div class="form-group row mb-4">
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="password" name="password_confirmation" class="form-control" id="ulangi_password" placeholder="Ulangi Password Anda...">
                        </div>
                    </div>
                    <button type="submit" name="simpan" class="btn btn-primary mb-5">Ubah</button>
                    <a href="{{ route('user.edit_profil', ['username' => auth()->user()->username]) }}" class="btn btn-danger mb-5">Kembali</a>
                </form>
