  ...
  <main class="main">
    ...
    <section id="hero" class="hero section">
      <div class="hero-bg">
        <img src="<?= MAIN_URL ?>assets/user-layout/img/hero-bg-light.webp" alt="">
      </div>
      ...
      <div class="container">
        <div class="row gy-4">
          ...
          <div class="col-lg-6 about-images" data-aos="fade-up" data-aos-delay="200">
            <div class="row gy-4">
              <div class="col-lg-6">
                <img src="<?= MAIN_URL ?>assets/user-layout/img/about-company-1.jpg" class="img-fluid" alt="">
              </div>
              <div class="col-lg-6">
                <div class="row gy-4">
                  <div class="col-lg-12">
                    <img src="<?= MAIN_URL ?>assets/user-layout/img/about-company-2.jpg" class="img-fluid" alt="">
                  </div>
                  <div class="col-lg-12">
                    <img src="<?= MAIN_URL ?>assets/user-layout/img/about-company-3.jpg" class="img-fluid" alt="">
                  </div>
                </div>
              </div>
            </div>
        ...
        <div class="row gy-4 justify-content-between features-item">
          ...
          <div class="col-lg-5 d-flex align-items-center" data-aos="fade-up" data-aos-delay="200">
            <div class="content">
              ...
              <a href="./auth/register" class="btn more-btn">Daftar</a>
            </div>
          </div>
        </div>
        <!-- Features Item -->
