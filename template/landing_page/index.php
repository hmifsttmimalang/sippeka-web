...
<head>
  ...
  <!-- Favicons -->
  <link href="assets/img/silastri/logo_jatim.png" rel="icon">
  ...
  <header id="header" class="header d-flex align-items-center fixed-top">
    <div class="container-fluid container-xl position-relative d-flex align-items-center">
      ...
      <a href="index.html" class="logo d-flex align-items-center me-auto">
        <img src="assets/img/silastri/logo_jatim.png" alt="">
      ...
      <a class="btn-getstarted" href="register.php">Sign Up</a>
      ...
      <div class="container">
        ...
        <div class="row gy-4">
          ...
          <div class="col-lg-6 content" data-aos="fade-up" data-aos-delay="100">
            ...
            <ul>
              <li><i class="bi bi-check-circle"></i> <span>Penyediaan Program Pelatihan Berbasis Kebutuhan Industri.</span></li>
              <li><i class="bi bi-check-circle"></i> <span>Fokus pada Pemberdayaan Masyarakat Melalui Pendidikan Keterampilan.</span></li>
      ...
      <div class="container" data-aos="fade-up">
        ...
        <div class="row gy-4">
          ...
          <div class="col-xl-2 col-md-3 col-6 client-logo">
            <img src="assets/img/silastri/logo_jatim.png" class="img-fluid" alt="">
          </div><!-- End Client Item -->

          <div class="col-xl-2 col-md-3 col-6 client-logo">
            <img src="assets/img/silastri/logo_disnakertrans.png" class="img-fluid" alt="">
          </div><!-- End Client Item -->

          <div class="col-xl-2 col-md-3 col-6 client-logo">
            <img src="assets/img/silastri/logo_berakhlak.png" class="img-fluid" alt="">
          </div><!-- End Client Item -->

          <div class="col-xl-2 col-md-3 col-6 client-logo">
            <img src="assets/img/silastri/logo_bangga.png" class="img-fluid" alt="">
          </div><!-- End Client Item -->

          <div class="col-xl-2 col-md-3 col-6 client-logo">
            <img src="assets/img/silastri/logo_zona_integritas.png" class="img-fluid" alt="">
          </div><!-- End Client Item -->
              ...
              <li class="nav-item">
                <a class="nav-link" data-bs-toggle="tab" data-bs-target="#features-tab-3">
                  ...
                  <div>
                    ...
                    <p>
                      Peserta dapat membangun jaringan profesional yang dapat mendukung perkembangan karir mereka di masa depan.
                    </p>
                  </div>
                </a>
              </li>
          ...
          <div class="col-lg-6" data-aos="fade-up" data-aos-delay="600">
            <div class="service-item item-pink position-relative">
              ...
              <div>
                ...
                <p>Mencakup Survei Kepuasan Masyarakat, Survei Persepsi Kualitas Pelayanan (SPKP) dan Survei Persepsi Anti Korupsi (SPAK), 
      ...
      <div class="row">
        ...
        <form action="forms/newsletter.php" method="post" class="php-email-form">
            <div class="newsletter-form">
                <input type="email" name="email" placeholder="Email Kamu" class="form-control me-2">
