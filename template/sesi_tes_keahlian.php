                    ...
                    <!-- Button Add Data -->
                     <div class="d-flex justify-content-left">
                        ...
                        <form action="" class="form-inline my-2 my-lg-0">
                            <a href="tambah_sesi_keahlian.php" class="btn btn-primary btn-sm mr-sm-4 mb-4">
                                ...
                                <table class="table table-bordered table-hover">
                                  ...
                                  <tbody>
                                    <tr>
                                        ...
                                        <td>
                                        <a href="detail_sesi_keahlian.php" class="btn btn-secondary btn-sm">
                                            <i class="bi bi-eye"></i>
                                        </a>
                                        <a href="edit_sesi_keahlian.php" class="btn btn-primary btn-sm">
